          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="py-4 flex flex-col items-center justify-center space-y-4">
                <a 
                  href={`https://portal.pdpa.click/dl?ref=${request.trackingNo}`} 
                  target="_blank" 
                  rel="noreferrer"
                ...
                <div className="pt-2 flex flex-col items-center space-y-2">
                  ...
                  <img 
                    src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://portal.pdpa.click/dl?ref=${request.trackingNo}`} 
                    alt="QR Code" 
              ...
              <p className="text-xs text-slate-500 pt-4 border-t border-slate-100">
                ...
                สามารถนำรหัสคำขอ {request.trackingNo} ไปตรวจสอบได้ที่ <a href="#" className="text-brand-600 hover:underline">portal.pdpa.click/verify</a><br/>
                <br/>
                ขอแสดงความนับถือ<br/>
                {org.nameTh}
              </p>
