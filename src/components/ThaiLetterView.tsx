...
export const ThaiLetterView: React.FC<ThaiLetterViewProps> = ({
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="print-area bg-white font-sarabun text-[12pt] leading-normal text-black w-[210mm] min-h-[297mm] mx-auto shadow-md relative pt-[2.5cm] pb-[2cm] pl-[3cm] pr-[2cm] print:shadow-none print:w-[210mm] print:h-[297mm]">
