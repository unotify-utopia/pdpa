...
export const initialDocumentTemplates: DocumentTemplate[] = [
  ...
  },
  {
    ...
    bodyTemplate: 'เรียน คุณ {{requesterName}}\n\nองค์กรได้พิจารณาอนุมัติการเข้าถึงข้อมูลตามสิทธิของท่านเรียบร้อยแล้ว รายละเอียดข้อมูลของท่านได้รับการตรวจสอบและจัดเตรียมไว้เป็นที่เรียบร้อย\n\nช่องทางดาวน์โหลดและตรวจสอบความถูกต้องเอกสาร (ใช้งานได้ {{downloadExpiryDays}} วัน):\n1. สแกน QR Code ที่มุมขวาล่างของเอกสารด้วยโทรศัพท์มือถือ\n2. หรือเข้าเว็บไซต์: pdpa.numcomputer.com/dl\n   และระบุรหัสอ้างอิง: {{trackingNo}}\n\n*ข้อแนะนำในการเข้าถึงข้อมูล: ท่านต้องกรอกรหัสผ่านแบบใช้ครั้งเดียว (OTP) ที่จะส่งเข้ามือถือหรืออีเมลของท่านเมื่อเข้าสู่หน้าดาวน์โหลด*',
    version: '1.0',
...
export const seedRequests: Request[] = [
  ...
  },
  {
    ...
    messageThread: [
      { id: 'msg_008_1', sender: 'user', senderName: 'ฟกดฟกด ฟกดฟกดอฟ', message: 'ทดสอบการส่งข้อความ', timestamp: '2026-07-23T09:06:14+07:00' },
      { id: 'msg_008_2', sender: 'staff', senderName: 'พงศธร เทคโนโลยี (Tech Intake)', message: 'เรียน คุณ ฟกดฟกด องค์กรขอรับหลักฐานเพิ่มเติมเนื่องจากเอกสารหลักฐานตรวจสอบความสมบูรณ์ไม่ผ่าน คือ: เอกสารยืนยันตัวตน / สำเนาบัตรประชาชนที่ชัดเจน กรุณาอัปโหลดเอกสารใหม่เพิ่มเติมเข้าระบบในหน้าติดตามสถานะ', timestamp: '2026-07-23T10:29:08+07:00' }
    ],
    legalHold: false
  },
  {
    ...
    messageThread: [
      { id: 'msg_d008_1', sender: 'user', senderName: 'ฟกดฟกด ฟกดฟกดอฟ', message: 'ทดสอบการส่งข้อความ', timestamp: '2026-07-23T09:06:14+07:00' },
