...
app.listen(PORT, () => {
  ...
  dbPool.query("UPDATE tenants SET name_th = REPLACE(name_th, ' (ทดสอบ)', '')")
    .then(() => console.log('Removed (ทดสอบ) from tenants'))
    .catch(err => console.error('Failed to update tenants', err));
