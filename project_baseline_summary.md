...
## ?? 6. ????????????????????? (Ironclad Rules)
1. **Conventional Commits:** ???????????????????????????????? Bat File ??????? AI ?????????????????????????? Commit Message ???????? Conventional Commits ???? (???? ix: ..., eat: ..., chore: ...) ??? **AI ?????????? Commit Message ?????? User ????** ??????????????? Git ????????????????????????????????
2. **Security-First:** ??????? API Key ???????????????????????? Frontend (React) ???? Hardcode ???????? JS ??????? ??????????? \.env\ ????????
